...
class User:
    ...
    def add_user(self, username, useremail, userpassword, userrights, defaultproofreader):
    ...
    def verify_user(self, username, userpassword):
        ...
        if len(user_data["User"]) == 1 and len(user_data["Password"]) == 1:
            user_session = {"User": user_data["User"][0], "Email": user_data["Email"][0], "Password": user_data["Password"][0], "Rights": user_data["Rights"][0]}
