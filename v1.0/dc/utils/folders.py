...
class Folders:
    ...
    def create_needed_dirs(self):
        ...
        extraDirs = [root_path, 'excels exported', 'excels to be imported', 'FUDB']
    ...
    def defaultconfig(self):
        ...
        config_data = {
                ...
                "path_to_checklist": "FUDB/DC Checklist v1.0.0.xlsm",
                ...
                "batch_status_options_responsible": "PREP. OP FILE, OP FILE TO CHECK, IMPORTATION & SPLIT FILE, SPLIT FILE TO CHECK, RELIABILITY & DATA UPGRADE, FRONT END TO CHECK, **TO BE CHECKED",
    ...
    def new_opfiles_info(self):
        ...
        if len(new_folders) > 1:
            raise Exception("Sorry but only one folder is accepted in '0 NEW'!")
        elif len(new_folders) == 0:
            raise Exception("No folder found in '0 NEW'!")
        else:
        ...
        if "ResponsibleStatus" in list(data.keys()):
            if data["ResponsibleStatus"] == "TO BE CHECKED":
                ...
                if folder_name in files:
                    ...
                    self.func.move_folder(src, dst)
                    try:
                        self.func.show_excel(conf["path_to_checklist"])
